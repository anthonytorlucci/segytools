...
def test_segy_file_header_segy_type():
    ...
    file_header.set_file_header_values(bsgy=bytes(file_header_bytearray), endianess='little')
    expected = segytools.datatypes.SegYType.IBM
    assert file_header.segy_type() == expected

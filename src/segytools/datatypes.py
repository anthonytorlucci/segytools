...
#--from segytools.ibm_float import MIN_IBM_FLOAT, MAX_IBM_FLOAT
...
DataSampleFormat_INT8 = DataSampleFormat(format='b', ctype='char', size_in_bytes=1)
DataSampleFormat_UINT8 = DataSampleFormat(format='B', ctype='unsigned char', size_in_bytes=1)
DataSampleFormat_INT16 = DataSampleFormat(format='h', ctype='short', size_in_bytes=2)
DataSampleFormat_UINT16 = DataSampleFormat(format='H', ctype='unsigned short', size_in_bytes=2)
DataSampleFormat_INT32 = DataSampleFormat(format='i', ctype='int', size_in_bytes=4)
DataSampleFormat_UINT32 = DataSampleFormat(format='I', ctype='unsigned int', size_in_bytes=4)
DataSampleFormat_FLOAT32 = DataSampleFormat(format='f', ctype='float', size_in_bytes=4)
DataSampleFormat_FLOAT64 = DataSampleFormat(format='d', ctype='double', size_in_bytes=8)
DataSampleFormat_IBM = DataSampleFormat(format='ibm', ctype='ibm', size_in_bytes=4)
